...
class BasketPage(BasePage):
    def should_be_empty_basket(self):
        ...
        assert self.is_element_present(*BasketPageLocators.BASKET_INNER), "Wrong basket"
        ...
        assert BasketPageLocators.empty_text[language] in text_in_basket, "Empty text not found"
